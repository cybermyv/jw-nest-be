...
export class ProductController {
    ...
    public async uploadProduct(
            ...
            @UploadedFile() file) {
                ...
                // const thumb = Buffer.from(file).toString('base64');
                // const thumb = file.buffer.toString('base64');
            ...
            //         if (err) throw err;
            //       thumb =  data.toString('base64');                   
                   
            //     });

                thumb = fs.readFileSync(path).toString('base64');
                ...
                throw new HttpException('Error upload product', HttpStatus.INTERNAL_SERVER_ERROR);
            }
